...
\title{Entrepreneurial Business Intelligence \\Social Network}
...
%
\author{José Ricardo Ruvalcaba Medrano}%
...
square brackets and consecutive numbers: ,
...
In order to permit cross \cite{Fitzpatrick2013TheTest} referencing within LNCS-Online, and eventually
...
journal articles \cite{Manso2014IncubioCalendar}, an LNCS chapter \cite{Osterwalder2008BusinessCanvas}, a book
\cite{Mendt2015DANDELIONREPORT}, proceedings without editors \cite{Blank2013WhyEverything} and
\cite{Mendt2015DANDELIONREPORT}, as well as a URL \cite{IjazAnsari2015DandelionPlan}.
Please note that proceedings published \cite{MansoIncubioCalendar} in LNCS are not cited with their
